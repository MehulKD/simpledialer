...
package com.mobileglobe.android.simpledialer.common.model.account;
...
import com.mobileglobe.android.customdialer.common.util.CommonDateUtils;
...
public class SamsungAccountType extends BaseAccountType {
    private static final String TAG = "KnownExternalAccType";
    ...
    public SamsungAccountType(Context context, String authenticatorPackageName, String type) {
        ...
        try {
            ...
            Log.e(TAG, "Problem building account", e);
        }
    }
