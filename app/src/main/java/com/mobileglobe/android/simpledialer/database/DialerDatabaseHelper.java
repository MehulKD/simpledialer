...
package com.mobileglobe.android.simpledialer.database;
...
import com.mobileglobe.android.simpledialer.database.VoicemailArchiveContract.VoicemailArchive;
import com.mobileglobe.android.simpledialer.dialpad.SmartDialNameMatcher;
import com.mobileglobe.android.simpledialer.dialpad.SmartDialPrefix;
...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static interface PhoneQuery {
       static final Uri URI = Phone.CONTENT_URI.buildUpon().
        ...
        static final String[] PROJECTION_V21 = new String[]{
                Phone._ID,                          // 0
                Phone.TYPE,                         // 1
                Phone.LABEL,                        // 2
                Phone.NUMBER,                       // 3
